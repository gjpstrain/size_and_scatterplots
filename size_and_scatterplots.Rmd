...
We therefore hypothesize that correlation estimation will be most accurate when
...
We present a single experiment study in which we demonstrate that the use of 
...
```{r changes-with-r-size, echo=FALSE, fig.align='default', fig.show='hold', fig.cap="hello", crop = TRUE, fig.env="figure*", crop = TRUE}
