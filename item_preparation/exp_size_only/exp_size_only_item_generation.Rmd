...
size_h_p <- rep(c(0.8), times = 2)

size_w_p <- rep(c(0.8), times = 2)

practice_data <- cbind(vis_threshold_images, size_h_p, size_w_p)

write.csv(practice_data, "vis_threshold_plots.csv", row.names = FALSE)
```
