...
of correlation (\cite{strain_2023}\footnote{Contains a full review of the history and contemporary issues regarding this work.}). Previous literature has found evidence for a pronounced underestimation in judgements
...
identical. This range of \emph{r} values was chosen as there is evidence from the literature
...
which we henceforth refer to as \emph{standard size},
...
was performed with the \textbf{emmeans} package (version 1.8.7 \cite{emmeans}), and
