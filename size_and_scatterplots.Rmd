...
# extract and process visual threshold testing
  ...
  visual_thresholds <- anon_file %>%
    ...
    dplyr::select(c("VT_with_labels", "participant", "VT_textbox2.text")) %>%
    ...
    dplyr::select("VT_no_correct", "participant")
...
in \cite{strain_2023}. Scatterplots were generated based on 45 uniformly distributed *r* values
...
While dot pitch is not necessary information for the present study, as we are only
...
Put something about narrowing the gap wrt psychophysical testing between online
and in-person experiments.
