...
```{r examples, echo=FALSE, fig.asp=1, fig.show='hold', fig.cap="Four levels of the point size condition, demonstrated with an \\textit{r} value of 0.6", out.width="100%"}
example_plots()
```
...
```{r dot-plot, echo=FALSE, fig.show='hold', fig.cap="Mean error in correlation estimates across the four size manipulation conditions, with 95\\% confidence intervals shown.", out.width="100%"}
...
```{r changes-with-r-size, echo=FALSE, fig.align='default', fig.show='hold', fig.cap="hello", crop = TRUE, fig.env="figure*"}
