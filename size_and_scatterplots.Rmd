...
The data used to generate the scatterplots in the current study were identical to that
used previously \cite{strain_2023}. Scatterplots were generated based on 45 uniformly 
distributed *r* values between 0.2 and 0.99, as there is evidence from the literature 
...
to point sizes in three of our conditions. We additionally adjusted the residual values
using a scaling factor of 4 and a constant of 0.2 to achieve a minimum on-screen point size of 12 pixels,
...
followed by the visual threshold testing described above and the screen scaling task
