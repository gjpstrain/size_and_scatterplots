...
are displayed in Table \ref{tab:contrasts-table}. Means and 95% confidence intervals
of correlation estimates are shown in Figure \ref{dot-plot}. The **EMAtools** package
...
```{r changes-with-r-size, echo=FALSE, fig.align='left', fig.show='hold', fig.cap="hello", crop = TRUE, fig.env="figure*"}
