...
of people's perceptions of correlations than previous work using fewer values (\textbf{maybe ref this}).
Previous work, including our own, used only positive \emph{r} values. As we are building on this
...
in \cite{strain_2023}.In our fourth condition, which we refer to as \emph{standard size},
