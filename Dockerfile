...
RUN R -e "devtools::install_version('emmeans', version = '1.8.7', dependencies = T)"
...
RUN R -e "devtools::install_version('insight', version = '0.19.3', dependencies = T)"
RUN R -e "devtools::install_version('afex', version = '1.3-0', dependencies = T)"
RUN R -e "devtools::install_version('bookdown', version = '0.34', dependencies = T)"
