...
future work will therefore take two directions:

1. We will investigate the effect of manipulating both point contrast and point
size. Will these effects be additive, and to what degree?

2. We will introduce a parameter to control the strength of the manipulation
according to the objective *r* value in order to fine tune the effects we have found.
