...
```{r error-plot, eval=FALSE, fig.align='center', fig.cap="Participants' mean \\textit{r} estimates plotted against the objective \\textit{r} value separately for each size decay condition.", fig.env="figure*", fig.pos="h", fig.show='hold', crop=TRUE, include=FALSE, out.width="100%", results=FALSE}
...
```{r changes-with-r-size, echo=FALSE, fig.show='hold', fig.cap="Participants' mean errors in \\textit{r} estimates plotted against the objective \\textit{r} value separately for each size decay condition. The dotted horizontal line represents accurate estimation.", fig.env="figure*", out.width= "100%", crop = TRUE}
